    ...
    */
    batch : {
      doc: {
        options: {
          cmd: function(f) {
            return '.\\node_modules\\.bin\\kss-node --source src --source node_modules/egeo.ui.base/dist/sass --destination dist --template node_modules/egeo.website.template/dist/kss-template --homepage readme.md --css public/styleguide.css';
          }
        },
        files: [{
          cwd: 'src',
